...
import { LoadingDefaultComponent, LogoComponent, NavbarComponent } from '@modules/shared'
...
export default function CartLayout({ children }: CartLayoutProps): JSX.Element {
	...
	const dataCarts = useGetCartsQuery()
	...
	return (
		<>
			{dataCarts.isLoading && <LoadingDefaultComponent />}
