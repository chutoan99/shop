...
import { StatusOrderComponent } from './components'
import ListsOrderComponent from './components/lists-order.component'
import { useGetOrderQuery } from '@hooks/apis/order.hook'

function OrderDetailPage(): JSX.Element {
	const params = useParams()
	console.log()
	const { data: dataOrder, isLoading } = useGetOrderQuery(Number(params.order_id))
