import { useGetFlashSaleQuery } from '@hooks/apis/flash-sale.hook'
import { IFlashSaleModel } from '@models/flash-sale.model'
						...
						<div className='col l-12 mo-12 c-12 mt-[20px]'>
							<div className='mb-[10px]'>
								<div className='row sm- px-[15px] pb-[12px]'>
									{data?.map((item: IFlashSaleModel, index: number) => (
										<div className='col l-2 mo-4 c-6' key={item.id}>
											<div
												...
												key={item.id}
												onClick={() => navigate(`/product/${item?.id}/${item?.shop_id}`)}>
