...
import { useGetCategoryTreeQuery } from '@hooks/apis/category.hook'
				...
				<div className='pt-[20px]'>
					<div className='bg-[#fff]'>
						...
						<Slider {...categoryConfig.settings}>
							{data?.map((category: ICategoryTreeModel[], index: number) => (
								<div key={index}>
									{category?.map((ele: ICategoryTreeModel, index: number) => (
										<NavLink
