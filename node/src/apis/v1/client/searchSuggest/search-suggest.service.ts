...
interface ISearchSuggestService {
	findSearchSuggests(): Promise<SearchSuggestResponse>
}

export default class SearchSuggestService implements ISearchSuggestService {
	...
	public findSearchSuggests = async (): Promise<SearchSuggestResponse> => {
		try {
			let total = 0
