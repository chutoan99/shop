...
interface IShopService {
	findShopItems(shopid: number): Promise<ShopItemsResponse>
	findShop(shopid: number): Promise<ShopResponse>
}
...
export default class ShopService implements IShopService{
	...
	public findShop = async (shopid: number): Promise<ShopResponse> => {
		try {
