...
interface ISearchHistoryService {
	findSearchHistories(userid: number): Promise<SearchHistoryResponse>
	createSearchHistory(
		payload: CreateSearchHistoryDto,
		userid: number
	): Promise<BaseResponse>
}
export default class SearchHistoryService implements ISearchHistoryService {
	...
	public findSearchHistories = async (
		userid: number
	...
	public createSearchHistory = async (
		payload: CreateSearchHistoryDto,
		userid: number
	): Promise<BaseResponse> => {
		try {
