...
export class BaseErrors {
	...
	public static notPaymentRequired(
		err: string | undefined,
		res: Response
	): Response {
	...
	//? 404:
	public static notFound(err: string | undefined, res: Response): Response {
	...
	public static notMethodNotAllowed(
		err: string | undefined,
		res: Response
	): Response {
	...
	public static notNotAcceptable(res: Response): Response {
	...
	public static notProxyAuthenticationRequired(res: Response): Response {
		const error = createError.ProxyAuthenticationRequired()
		return res
			.status(STATUS_CODE.CLIENT.PROXY_AUTHENTICATION_REQUIRED)
			.json({
				err: -1,
				mes: error.message
			})
	...
	public static notRequestTimeout(res: Response): Response {
	...
	public static notConflict(res: Response): Response {
	...
	public static notGone(res: Response): Response {
	...
	public static notLengthRequired(res: Response): Response {
	...
	public static notPreconditionFailed(res: Response): Response {
	...
	public static notPayloadTooLarge(res: Response): Response {
	...
	public static notURITooLong(res: Response): Response {
	...
	public static notUnsupportedMediaType(res: Response): Response {
	...
	public static notRangeNotSatisfiable(res: Response): Response {
	...
	public static notExpectationFailed(res: Response): Response {
	...
	public static internalServerError(res: Response, error?: any): Response {
	...
	public static notImplemented(err: any, res: Response): Response {
	...
	public staticnotBadGateway(err: any, res: Response): Response {
	...
	public static notServiceUnavailable(err: any, res: Response): Response {
	...
	public static notGatewayTimeout(err: any, res: Response): Response {
	...
	public static notHTTPVersionNotSupported(
		err: any,
		res: Response
	): Response {
