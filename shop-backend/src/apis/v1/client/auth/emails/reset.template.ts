            ...
            <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                     ...
                     <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                           <td style="height:40px;"> 
                            <a href=${EnvConfig.server.urlBackEnd}/resetPassword/${email}/${resetToken}
               ...
               <tr>
                  <td style="text-align:center;">
                     <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>Truongvanchutoan1999@gmail.com</strong></p>
                  </td>
               </tr>
               <tr>
                  <td style="height:80px;">&nbsp;</td>
